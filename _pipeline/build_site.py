...
<div><h4>Shop</h4><a href="{prefix}menu.html">Full dispensary menu</a>{links}</div>
<div><h4>Visit</h4><p>{e(STREET)}<br>{e(CITY)}, {e(STATE)} {e(ZIP)}<br><br>Mon–Sat 8am–8pm<br>Sun 10am–5pm<br><br><a href="tel:{PHONE_TEL}">{PHONE}</a></p></div>
